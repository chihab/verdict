...
yargs_1.default(helpers_1.hideBin(process.argv))
    .command("apply [project] [target]", "updates project with version", (yargs) => {
    yargs
        .positional("target", {
        type: "string",
    ...
    Promise.resolve().then(() => __importStar(require(`@versem/${project}`))).then((m) => m.run(target));
})
    .help()
...
function applyExtends(config, cwd, mergeExtends, _shim) {
    ...
    if (Object.prototype.hasOwnProperty.call(config, 'extends')) {
        ...
        if (!isPath) {
            try {
                pathToDefault = /*require.resolve*/(__nccwpck_require__(307).resolve(config.extends));
            }
            catch (_err) {
                return config;
            }
...
var cjsPlatformShim = {
    ...
    getProcessArgvBin: getProcessArgvBin,
    inspect,
    mainFilename: (_b = (_a =  false || __nccwpck_require__(307) === void 0 ? void 0 : __nccwpck_require__.c[__nccwpck_require__.s]) === null || _a === void 0 ? void 0 : _a.filename) !== null && _b !== void 0 ? _b : process.cwd(),
    Parser,
...
/******/ 	return __nccwpck_require__(__nccwpck_require__.s = 442);
/******/ })()
;