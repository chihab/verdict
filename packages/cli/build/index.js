...
module.exports = /******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 741: /***/ (
      ...
      const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
        if (colorConvert === undefined) {
          colorConvert = __nccwpck_require__(830);
        }
    ...
    /***/ 598: /***/ (
      ...
      const cssKeywords = __nccwpck_require__(407);
	...
	*/
    ...
    /***/ 830: /***/ (
      ...
      const conversions = __nccwpck_require__(598);
      const route = __nccwpck_require__(180);
...
*/
    ...
    /***/ 871: /***/ (
      ...
      const stripAnsi = __nccwpck_require__(361);
      const isFullwidthCodePoint = __nccwpck_require__(977);
      const emojiRegex = __nccwpck_require__(573);
    ...
    /***/ 361: /***/ (
      ...
      const ansiRegex = __nccwpck_require__(879);
    ...
    /***/ 413: /***/ (
      ...
      const stringWidth = __nccwpck_require__(871);
      const stripAnsi = __nccwpck_require__(361);
      const ansiStyles = __nccwpck_require__(741);
      ...
      const wrapAnsi = (code) =>
        ...
        }${ANSI_CSI}${code}${ANSI_SGR_TERMINATOR}`;
    ...
    /***/ 442: /***/ function (
      ...
      const yargs_1 = __importDefault(__nccwpck_require__(303));
      const helpers_1 = __nccwpck_require__(778);
      yargs_1
        ...
        .command(
          ...
          (argv) => {
            ...
            Promise.resolve()
              .then(() => __importStar(require(`@versem/${project}`)))
              .then((m) => m.run(target));
          }
        )
        .help()
    ...
    /***/ 264: /***/ (
      ...
      const stringWidth = __nccwpck_require__(871);
      const stripAnsi = __nccwpck_require__(361);
      const wrap = __nccwpck_require__(413);
      function ui(opts) {
        return cliui(opts, {
          stringWidth,
          stripAnsi,
    ...
    /***/ 60: /***/ (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      class YargsParser {
        ...
        parse(argsInput, options) {
          ...
          function setArg(key, val) {
            ...
            if (splitKey.length > 1 && configuration["dot-notation"]) {
              (flags.aliases[splitKey[0]] || []).forEach(function (x) {
                ...
                if (
                  !(flags.aliases[key] || []).includes(keyProperties.join("."))
                ) {
                  setKey(argv, keyProperties, value);
                }
              });
          ...
          function isUnknownOptionAsArg(arg) {
            return (
              configuration["unknown-options-as-args"] && isUnknownOption(arg)
            );
          }
      ...
      const parser = new YargsParser({
        ...
        require: (path) => {
          if (true) {
            return __nccwpck_require__(691)(path);
          } else {
          }
        },
      });
    ...
    /***/ 368: /***/ (
      ...
      function applyExtends(config, cwd, mergeExtends, _shim) {
        ...
        if (Object.prototype.hasOwnProperty.call(config, "extends")) {
          ...
          if (!isPath) {
            try {
              pathToDefault = /*require.resolve*/ __nccwpck_require__(
                307
          ...
          defaultConfig = isPath
            ...
            : __nccwpck_require__(307)(config.extends);
          ...
          if (isPromise(acc)) {
            ...
            return isPromise(result)
              ? result.then((middlewareObj) =>
                  Object.assign(acc, middlewareObj)
                )
      ...
      function whichModule(exported) {
        ...
        for (
          let i = 0, files = Object.keys(__nccwpck_require__.c), mod;
          i < files.length;
          i++
        ) {
      ...
      function command(yargs, usage, validation, globalMiddleware = [], shim) {
        ...
        self.addHandler = function addHandler(
          ...
          if (typeof cmd === "string") {
            ...
            let isDefault = false;
            const parsedAliases = [parsedCommand.cmd]
              .concat(aliases)
              .filter((c) => {
        ...
        function moduleName(obj) {
          ...
          if (!mod)
            throw new Error(
              `No command name given for module: ${shim.inspect(obj)}`
            );
        ...
        self.runCommand = function runCommand(
          ...
          if (isCommandBuilderCallback(builder)) {
            ...
            const innerYargs = isYargsInstance(builderOutput)
              ? builderOutput
              : yargs;
        ...
        self.runDefaultBuilderOn = function (yargs) {
          ...
          if (shouldUpdateUsage(yargs)) {
            ...
            yargs
              .getUsageInstance()
              .usage(commandString, defaultCommand.description);
          }
      ...
      function usage(yargs, y18n, shim) {
        ...
        self.help = function help() {
              ...
              ui.span(
                {
                  ...
                  padding: [0, 2, 0, 2],
                  width:
                    maxWidth(commands, theWrap, `${base$0}${parentCommands}`) +
                    4,
                },
                { text: command[1] }
              );
          ...
          const shortSwitchesUsed = displayedGroups
            .filter(
              ({ groupName }) => groupName !== self.getPositionalGroupName()
            )
            .some(
...
`;
      ...
      function completion(yargs, usage, command, shim) {
        ...
        const zshShell =
          (shim.getEnv("SHELL") &&
            shim.getEnv("SHELL").indexOf("zsh") !== -1) ||
          (shim.getEnv("ZSH_NAME") &&
            shim.getEnv("ZSH_NAME").indexOf("zsh") !== -1);
        ...
        self.generateCompletionScript = function generateCompletionScript(
          $0,
          cmd
        ) {
      ...
      function validation(yargs, usage, y18n, shim) {
        ...
        self.recommendCommands = function recommendCommands(
          cmd,
          potentialCommands
        ) {
          const threshold = 3;
      ...
      function Yargs(
        ...
        self.$0 = default$0
          .map((x) => {
            ...
            return x.match(/^(\/|([a-zA-Z]:)?\\)/) && b.length < x.length
              ? b
              : x;
          })
          .join(" ")
        ...
        if (
          shim$1.getEnv("_") &&
          shim$1.getProcessArgvBin() === shim$1.getEnv("_")
        ) {
          self.$0 = shim$1
            .getEnv("_")
        ...
        self.resetOptions = self.reset = function resetOptions(aliases = {}) {
          ...
          options = tmpOptions;
          usage$1 = usage$1
            ? usage$1.reset(localLookup)
            : usage(self, y18n, shim$1);
        ...
        self.default = self.defaults = function (
          ...
          if (typeof value === "function") {
            ...
            if (!options.defaultDescription[key])
              options.defaultDescription[key] = usage$1.functionDescription(
                value
              );
            value = value.call();
          }
        ...
        self.config = function config(key = "config", msg, parseFn) {
          ...
          self.describe(
            key,
            msg || usage$1.deferY18nLookup("Path to JSON config file")
          );
        ...
        self.commandDir = function (dir, opts) {
          ...
          command$1.addDirectory(
            dir,
            self.getContext(),
            req,
            shim$1.getCallerFile(),
            opts
          );
          return self;
        };
        ...
        self.option = self.options = function option(key, opt) {
          ...
          if (typeof key === "object") {
            ...
            if (opt.demandOption) {
              self.demandOption(
                key,
                typeof opt.demandOption === "string"
                  ? opt.demandOption
                  : undefined
              );
            }
        ...
        self.positional = function (key, opts) {
          ...
          opts = objFilter(opts, (k, v) => {
            ...
            if (
              k === "type" &&
              ["string", "number", "boolean"].indexOf(v) === -1
            )
              accept = false;
            return accept;
          });
          const fullCommand =
            context.fullCommands[context.fullCommands.length - 1];
        ...
        self.addShowHiddenOpt = self.showHidden = function addShowHiddenOpt(
          ...
          const showHiddenOpt =
            typeof opt === "string" ? opt : defaultShowHiddenOpt;
          self.boolean(showHiddenOpt);
          self.describe(
            showHiddenOpt,
            msg || usage$1.deferY18nLookup("Show hidden options")
          );
        ...
        self.showCompletionScript = function ($0, cmd) {
          ...
          $0 = $0 || self.$0;
          _logger.log(
            completion$1.generateCompletionScript(
              $0,
        ...
        self._parseArgs = function parseArgs(
          ...
          const parsed = shim$1.Parser.detailed(
            args,
            Object.assign({}, options, {
          ...
          try {
            ...
            if (argv._.length) {
              if (handlerKeys.length) {
                ...
                for (
                  let i = commandIndex || 0, cmd;
                  argv._[i] !== undefined;
                  i++
                ) {
                  cmd = String(argv._[i]);
                  if (~handlerKeys.indexOf(cmd) && cmd !== completionCommand) {
                    const innerArgv = command$1.runCommand(
                      cmd,
                      self,
                      parsed,
                      i + 1
                ...
                if (
                  ...
                  validation$1.recommendCommands(
                    firstUnknownCommand,
                    handlerKeys
                  );
                }
            ...
            if (requestCompletions) {
              ...
              const completionArgs = args.slice(
                args.indexOf(`--${completion$1.completionKey}`) + 1
              );
        ...
        self._parsePositionalNumbers = function (argv) {
          ...
          for (let i = 0, arg; (arg = args[i]) !== undefined; i++) {
            if (
              shim$1.Parser.looksLikeNumber(arg) &&
      ...
      const y18n = __nccwpck_require__(597);
      const Parser = __nccwpck_require__(60);
      var cjsPlatformShim = {
        assert: {
          notStrictEqual: assert.notStrictEqual,
          strictEqual: assert.strictEqual,
        },
        cliui: __nccwpck_require__(264),
        findUp: __nccwpck_require__(993),
        getEnv: (key) => {
          return process.env[key];
        },
        getCallerFile: __nccwpck_require__(288),
        getProcessArgvBin: getProcessArgvBin,
        inspect,
        mainFilename:
          (_b =
            (_a =
              false || __nccwpck_require__(307) === void 0
                ? void 0
                : __nccwpck_require__.c[__nccwpck_require__.s]) === null ||
            _a === void 0
              ? void 0
        ...
        readFileSync,
        require: __nccwpck_require__(307),
        requireDirectory: __nccwpck_require__(512),
        stringWidth: __nccwpck_require__(871),
        y18n: y18n({
      ...
      const Parser$1 = __nccwpck_require__(60);
    ...
    /***/ 303: /***/ (
      ...
      const { Yargs, processArgv } = __nccwpck_require__(368);
      ...
      function Argv(processArgs, cwd) {
        const argv = Yargs(processArgs, cwd, __nccwpck_require__(186));
        singletonify(argv);
        return argv;
      }
...
*/
  ...
  /******/
  /******/ /******/ __nccwpck_require__.c = __webpack_module_cache__; /* webpack/runtime/hasOwnProperty shorthand */
  /******/
  /************************************************************************/
  /******/ /******/ (() => {
